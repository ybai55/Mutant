# MIP Mutant Improvment Proposals

## Purpose

We want to make Mutant a core architectural component for users. Core architectural
...
## What is considered a "major change" that needs a MIP?
...
## What should be included in a MIP?

A MIP should contain the following sections:
...
## Who should initiate the MIP?

Anyone can initiate a MIP - we welcome ideas about how to improve Mutant, the core
Mutant team will review, provide feedback, and come to a decision on if the proposal
makes sense for the long term direction of Mutant.
