...
import mutant
import mutant.server
from mutant.errors import NoDatapointsException
from mutant.server.fastapi.types import (
    AddEmbedding,
    CountEmbedding,
    DeleteEmbedding,
    FetchEmbedding,
...
class FastAPI(mutant.server.Server):
    ...
    def __init__(self, settings):
        ...
        self.router.add_api_route(
            "/api/v1/add", self.add, methods=["POST"], status_code=fastapi.status.HTTP_201_CREATED
        )
