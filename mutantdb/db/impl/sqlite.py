from mutantdb.db.impl.sqlite_pool import Connection, LockPool, PerThreadPool, Pool
from mutantdb.db.migrations import MigratableDB, Migration
from mutantdb.config import System, Settings
import mutantdb.db.base as base
from mutantdb.db.mixins.embeddings_queue import SqlEmbeddingsQueue
from mutantdb.db.mixins.sysdb import SqlSysDB
from mutantdb.utils.delete_file import delete_file
import sqlite3
...
class SqliteDB(MigratableDB, SqlEmbeddingsQueue, SqlSysDB):
    ...
    def __init__(self, system: System):
        ...
        self._migration_imports = [
            files("mutantdb.migrations.embeddings_queue"),
            files("mutantdb.migrations.sysdb"),
            files("mutantdb.migrations.metadb"),
        ]
        ...
        if not self._is_persistent:
            ...
            self._db_file = (
                self._settings.require("persist_directory") + "/mutant.sqlite3"
            )
