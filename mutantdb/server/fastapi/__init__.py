...
from mutantdb.server.fastapi.types import (AddEmbedding, CountEmbedding, DeleteEmbedding,
...
class FastAPI(mutantdb.server.Server):
    ...
    def __init__(self, settings):
        ...
        self.router.add_api_route("/api/v1/collections/{collection_name}/add", self.add, methods=["POST"],
        ...
        self.router.add_api_route("/api/v1/collections/{collection_name}/query", self.get_nearest_neighbors,
                                  methods=["POST"])
        self.router.add_api_route("/api/v1/collections/{collection_name}/create_index", self.create_index,
                                  methods=["POST"])
