...
from mutantdb.config import System, get_class
from mutantdb.db.system import SysDB
from overrides import override
from enum import Enum
from mutantdb.segment.impl.vector.local_persistent_hnsw import (
    PersistentLocalHnswSegment,
)
from mutantdb.types import Collection, Operation, Segment, SegmentScope, Metadata
from typing import Dict, Type, Sequence, Optional, cast
from uuid import UUID, uuid4
from collections import defaultdict
import platform

from mutantdb.utils.lru_cache import LRUCache
...
class SegmentType(Enum):
    SQLITE = "urn:mutant:segment/metadata/sqlite"
    HNSW_LOCAL_MEMORY = "urn:mutant:segment/vector/hnsw-local-memory"
    HNSW_LOCAL_PERSISTED = "urn:mutant:segment/vector/hnsw-local-persisted"


SEGMENT_TYPE_IMPLS = {
    SegmentType.SQLITE: "mutantdb.segment.impl.metadata.sqlite.SqliteMetadataSegment",
    SegmentType.HNSW_LOCAL_MEMORY: "mutantdb.segment.impl.vector.local_hnsw.LocalHnswSegment",
    SegmentType.HNSW_LOCAL_PERSISTED: "mutantdb.segment.impl.vector.local_persistent_hnsw.PersistentLocalHnswSegment",
}
