...
import mutantdb.api.types as types
import re
...
from mutantdb.api.types import Documents, Embeddings, Metadata
...
def collections(
    ...
    if with_hnsw_params:
        ...
        if draw(st.booleans()):
            ...
            # in tests once https://github.com/mutant-core/issues/issues/61 lands
