...
try:
    from mutantdb.is_thin_client import is_thin_client  # type: ignore
except ImportError:
    is_thin_client = False
...
_legacy_config_values = {
    ...
    "local",
    "rest",
    "mutantdb.db.duckdb.DuckDB",
    "mutantdb.db.duckdb.PersistentDuckDB",
    "mutantdb.db.clickhouse.Clickhouse",
    "mutantdb.api.local.LocalAPI",
}

# TODO: Don't use concrete types here to avoid circular deps. Strings are fine for right here!
_abstract_type_keys: Dict[str, str] = {
    "mutantdb.api.API": "mutant_api_impl",
    "mutantdb.telemetry.Telemetry": "mutant_telemetry_impl",
    "mutantdb.ingest.Producer": "mutant_producer_impl",
    "mutantdb.ingest.Consumer": "mutant_consumer_impl",
    "mutantdb.db.system.SysDB": "mutant_sysdb_impl",
    "mutantdb.segment.SegmentManager": "mutant_segment_manager_impl",
}
...
class Settings(BaseSettings):
    ...
    mutant_db_impl: Optional[str] = None

    mutant_api_impl: str = "mutantdb.api.segment.SegmentAPI"  # Can be "mutantdb.api.segment.SegmentAPI" or "mutantdb.api.fastapi.FastAPI"
    mutant_telemetry_impl: str = "mutantdb.telemetry.posthog.Posthog"

    # New architecture components
    mutant_sysdb_impl: str = "mutantdb.db.impl.sqlite.SqliteDB"
    mutant_producer_impl: str = "mutantdb.db.impl.sqlite.SqliteDB"
    mutant_consumer_impl: str = "mutantdb.db.impl.sqlite.SqliteDB"
    mutant_segment_manager_impl: str = (
        "mutantdb.segment.impl.manager.local.LocalSegmentManager"
    )
    ...
    mutant_server_host: Optional[str] = None
    mutant_server_headers: Optional[Dict[str, str]] = None
    mutant_server_http_port: Optional[str] = None
    mutant_server_ssl_enabled: Optional[bool] = False
    mutant_server_grpc_port: Optional[str] = None
    mutant_server_cors_allow_origins: List[str] = []  # eg ["http://localhost:3000"]
