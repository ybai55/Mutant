...
import mutantdb
from mutantdb.config import Component
...
class Telemetry(Component):
    USER_ID_PATH = str(Path.home() / ".cache" / "mutant" / "telemetry_user_id")
    ...
    def context(self) -> Dict[str, Any]:
        mutant_version = mutantdb.__version__
        settings = mutantdb.get_settings()
        telemetry_settings = {}
